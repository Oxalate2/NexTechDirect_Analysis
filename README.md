...
## Client Background
NexTech Direct is a US-based e-commerce retailer that specializes in consumer electronics. Operating across multiple major regions globally, the company sells a variety of popular electronics, while running a loyalty program aimed at driving repeat purchases and long-term customer retention. This analysis will be split into 3 parts covering NexTech Direct’s underutilized data from 2019 to 2022.

**Sales Trends**:
An exploration of how NexTech Direct's sales performance evolved across a four-year period marked by significant external disruption, looking at key metrics across time, region, and product.

**Loyalty Program**:
An evaluation of whether NexTech Direct's loyalty program delivered measurable value by comparing purchasing behavior and revenue contribution between members and non-members.
...
## Loyalty Program
### Member Value
Across all 3 core sales metrics: **AOV, total revenue, and order volume,** loyalty member show a clear and accelerating value advantage over the period of 2019-2022.
...
- Monitor the gradual uptick in the "**Other**" products as it may signal an opportunity to diversity the catalog beyond the four core products before over-reliance on them.
...
- Clarify where the absence of refund activity in 2022 reflects a policy change, or just simply due to incomplete data.
